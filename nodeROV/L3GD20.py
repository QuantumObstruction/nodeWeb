...
data0 = bus.read_byte_data(gAddr, 0x2A)
data1 = bus.read_byte_data(gAddr, 0x2B)
...
data0 = bus.read_byte_data(gAddr, 0x2C)
data1 = bus.read_byte_data(gAddr, 0x2D)
